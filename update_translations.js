...
const files = [
  { path: './messages/ar.json', updates: { view: 'عرض', edit: 'تعديل', delete: 'حذف', save: 'حفظ', saving: 'جاري الحفظ...' } },
  { path: './messages/en.json', updates: { view: 'View', edit: 'Edit', delete: 'Delete', save: 'Save', saving: 'Saving...' } }
];
