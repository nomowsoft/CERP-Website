  ...
  return (
    <section dir={`${locale === "ar" ? "rtl" : "ltr"}`} className="bg-gray-50/20 min-h-screen">
      <section className="pt-32 pb-32 relative overflow-hidden bg-gradient-to-b from-gray-50 to-primary/5">
        ...
        <div className="hidden xl:flex absolute bottom-24 right-12 xl:right-32 items-center gap-2 bg-white/70 backdrop-blur-sm px-5 py-2.5 rounded-full shadow-sm border border-white z-10 animate-[bounce_8s_infinite_1.5s]" data-aos="fade-up" data-aos-delay="800">
