      ...
      <body className="font-tajawalregular font-bold">
        <NextIntlClientProvider messages={messages}>
          ...
          <div className={`fixed bottom-20 ${locale === "ar" ? "left-8" : "right-8"} z-50`}>
            <Link href="https://wa.me/966537802802" target="_blank" className="block lg:hidden">
              <Image src="/footer/whatsapp.png" alt="..." width={60} height={20} />
            </Link>
            <Link href="https://web.whatsapp.com/send?phone=966537802802" target="_blank" className="hidden lg:block">
              <Image src="/footer/whatsapp.png" alt="..." width={60} height={20} />
            </Link>
          </div>
